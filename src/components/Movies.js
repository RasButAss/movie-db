  ...
  return (
    ...
    {movie.map((element) => {return (
        <div key={element.id} className='col-md-3 mt-3 mb-3'>
            <Card movie_name={element.title} tv_name={element.name} image={element.poster_path === null ? "https://st.depositphotos.com/1670531/2557/i/600/depositphotos_25572559-stock-photo-man-wearing-vendetta-mask.jpg" : "https://image.tmdb.org/t/p/w500" + element.poster_path} 
